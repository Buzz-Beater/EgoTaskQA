...
class Embedding(nn.Module):
    def __init__(self, vocab_size=10,glove=None):
...
class base_lstm(nn.Module):
    ...
    def forward(self, x): # # lstm_input: B x seq x 300
        # Set initial states
...
class pure_lstm(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, num_classes,
                question_pt_path='data/glove.pt',):
        ...
        self.embedding = Embedding(self.vocab_size, self.glove_matrix)
...
if __name__ == '__main__':
    ...
    lstm = pure_lstm(300, 256, 1, num_classes=10)
    output = lstm(sentences)
