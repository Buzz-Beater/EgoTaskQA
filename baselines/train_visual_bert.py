...
def parse_args():
    ...
    parser.add_argument("--name", type=str, default='visual_bert_logs',
                        help='where to store ckpts and logs')
...
def train(args):
    ...
    visualbert = visual_bert.VisualBERT(output_dim=args.output_dim, max_len=args.max_len).to(args.device) # #
